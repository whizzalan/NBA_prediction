library(RCurl)
library(XML)
x <- getURL("https://raw.githubusercontent.com/ShaneKao/nba/b4074a7377011d4de92b1743b0209a00c8ca4816/stat.csv",ssl.verifypeer=FALSE)
...
webpage<-getURL("http://www.basketball-reference.com/leagues/NBA_2015.html#all_misc_stats",ssl.verifypeer = FALSE)
